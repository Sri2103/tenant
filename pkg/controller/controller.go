...
func New(
	...
	tenantInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc:    func(obj interface{}) { g.enqueue(obj) },
		UpdateFunc: func(oldObj, newObj interface{}) { g.enqueue(newObj) },
		DeleteFunc: func(obj interface{}) { g.enqueue(obj) },
	})
...
func (c *Controller) ensureNamespace(ctx context.Context, tenant *v1alpha1.Tenant, nsName string) error {
...
// ensureResourceQuota
func (c *Controller) ensureResourceQuota(ctx context.Context, tenant *v1alpha1.Tenant, nsName string) error {
...
// ensureLimitRange
func (c *Controller) ensureLimitRange(ctx context.Context, tenant *v1alpha1.Tenant, nsName string) error {
...
// ensureNetworkPolicy
func (c *Controller) ensureNetworkPolicy(ctx context.Context, tenant *v1alpha1.Tenant, nsName string) error {
...
// ensure RBAC
func (c *Controller) ensureRBAC(ctx context.Context, tenant *v1alpha1.Tenant, nsName string) error {
